...
Дальнейшее развитие проекта - vvip-68 ["ссылка на репозиторий"](https://github.com/vvip-68/GyverMatrixWiFi)  
#### Изменения по справнению с исходным проектом:
 ...
 - Если не удается подключиться к сети (неверный пароль или имя сети) - запускается режим [SmartConfig](#smartconfig),
...
О: Данная технология позволяет передать настройки в устройство без создания программной точки достпуа, посредством специального
   <a href="https://www.espressif.com/sites/default/files/documentation/esp-touch_user_guide_en.pdf">протокола</a>. Все, что необходимо
   сделать &mdash; это установить приложение <a href="https://play.google.com/store/apps/details?id=com.khoazero123.iot_esptouch_demo">EspTouch: SmartConfig for ESP8266, ESP32</a>.
